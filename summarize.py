...
st.title("Ask PDF using Llama 3.1")
st.caption("This app lets you get insights from a PDF using Llama 3.1, running locally with Ollama!")

def embedchain_bot(db_path):
    return App.from_config(
        config={
            "llm": {"provider": "ollama", "config": {"model": "llama3.1", "max_tokens": 250, "temperature": 0.5, "stream": True, "base_url": 'http://localhost:11434'}},
